...
|Strategy|Natural Normal Imputation: Gaussian noise centered 
around healthy means (e.g., RVSP $25 \pm 4 \text{ mmHg}$) to  the statistical variance of a healthy population|
